...
class TestRunCommands:
    ...
    def test_query_with_model(self):
        ...
        self.mock_runtime.orchestrate.assert_awaited_once_with(TEST_QUERY, model=TEST_MODEL)
    ...
    def test_runtime_unavailable(self):
        ...
        with patch('local_coding_assistant.cli.commands.run.typer.echo') as mock_echo:
            ...
            mock_echo.assert_any_call("Error: Runtime manager not available (LLM initialization failed)")
    ...
    def test_safe_entrypoint_decorator(self):
        ...
        assert original_func is not query, "Function should be wrapped by @safe_entrypoint"

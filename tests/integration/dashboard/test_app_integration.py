        ...
        with patch.dict('sys.modules', {'uvicorn': Mock()}):
            ...
            with patch('sys.argv', ['run_dashboard.py', '--port', '8080']):
                with patch.object(uvicorn_mock, 'run') as mock_uvicorn:
                    ...
                    with patch('local_coding_assistant.dashboard.app.create_app') as mock_create_app:
                        mock_app = Mock()
...
class TestDashboardErrorRecovery:
    ...
    def test_recovery_from_event_collector_errors(self):
        ...
        with patch('local_coding_assistant.dashboard.routes.api.get_event_collector') as mock_get:
            ...
            mock_collector.get_dashboard_stats.side_effect = Exception("Temporary error")
    ...
    def test_template_rendering_errors(self):
        ...
        with patch('local_coding_assistant.dashboard.routes.main.templates.TemplateResponse') as mock_template:
